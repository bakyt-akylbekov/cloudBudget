(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">' +
            ...
            '.dd-selected{ overflow:hidden; display:flex; align-items: center; padding:10px; }' +
            ...
            '.dd-option{height: 52px; padding:10px; display:flex;align-items: center; border-bottom:solid 1px #ddd; overflow:hidden; text-decoration:none; color:#333; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }' +
            ...
            '.dd-option-image, ' +
            '.dd-selected-image { vertical-align:middle; float:left; margin-right:5px; max-width:64px; width: 32px;\n' +
            '    height: 32px;\n' +
            '    border-radius: 50%}' +
